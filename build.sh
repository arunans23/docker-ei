...
DISTRIBUTION_NAME=wso2mi-4.4.0-beta.zip
WSO2_SERVER_DIST_URL=https://github.com/wso2/product-micro-integrator/releases/download/v4.4.0-beta/wso2mi-4.4.0-beta.zip
